                ...
                assignments.filter((assignment: Assignment) => assignment._id === aid).map((assignment, index) => (
                    <Form>
                        ...
                        <Form.Group className="mb-3 w-100" controlId="wd-textarea">
                            ...
                            <Form.Control as="textarea" rows={5} cols={10} defaultValue={assignment.description}></Form.Control>
                        </Form.Group>
                        ...
                        <Form.Control id="wd-assign-to" defaultValue="Everyone" className="mb-2" /> */}
                                    ...
                                    <Form.Control id="wd-due-date" type="datetime-local" defaultValue= {assignment.dueDate} className="mb-2" />

                                    <Row>
                                        <Col>
                                            <Form.Label htmlFor="wd-available-from">Available from</Form.Label>
                                            <Form.Control type="datetime-local" id="wd-available-from" defaultValue={assignment.startDate} />
                                        </Col>
                                        <Col>
                                            <Form.Label htmlFor="wd-available-until">Until</Form.Label>
                                            <Form.Control type="datetime-local" id="wd-available-until" defaultValue={assignment.dueDate} />
                                        </Col>
                                    </Row>
